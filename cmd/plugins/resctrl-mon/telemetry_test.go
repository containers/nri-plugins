...
func TestSourceFor(t *testing.T) {
	assert.Equal(t, "pod", sourceFor("12345678-1234-1234-1234-123456789abc"))
	assert.Equal(t, "other", sourceFor("machine-qemu-1-vm"))
	assert.Equal(t, "other", sourceFor("not-a-uuid"))
}
