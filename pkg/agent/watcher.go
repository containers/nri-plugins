...
import (
	...
	resmgrcli "github.com/intel/nri-resmgr/pkg/apis/resmgr/generated/clientset/versioned/typed/resmgr/v1alpha1"
...
func (w *watcher) patchAdjustment(adjust *resmgr.Adjustment, inscope bool, errors map[string]string) error {
	...
	if _, err := w.resmgrCli.Adjustments(opts.configNs).Patch(context.TODO(), adjust.Name, ptype, pdata, meta_v1.PatchOptions{}); err != nil {
