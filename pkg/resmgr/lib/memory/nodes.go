...
// HasMemory returns true of the node has some memory attached.
...
// until the function returns false. The function is passed the distance and
// the set of nodes at that distance.
...
// String returns a string represenation of the NodeMask.
