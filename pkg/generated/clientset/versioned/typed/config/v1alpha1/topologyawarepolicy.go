...
func (c *topologyAwarePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TopologyAwarePolicy, err error) {
	result = &v1alpha1.TopologyAwarePolicy{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("topologyawarepolicies").
		Name(name).
...
func (c *topologyAwarePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TopologyAwarePolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TopologyAwarePolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("topologyawarepolicies").
...
func (c *topologyAwarePolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *topologyAwarePolicies) Create(ctx context.Context, topologyAwarePolicy *v1alpha1.TopologyAwarePolicy, opts v1.CreateOptions) (result *v1alpha1.TopologyAwarePolicy, err error) {
	result = &v1alpha1.TopologyAwarePolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("topologyawarepolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(topologyAwarePolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *topologyAwarePolicies) Update(ctx context.Context, topologyAwarePolicy *v1alpha1.TopologyAwarePolicy, opts v1.UpdateOptions) (result *v1alpha1.TopologyAwarePolicy, err error) {
	result = &v1alpha1.TopologyAwarePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("topologyawarepolicies").
		Name(topologyAwarePolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(topologyAwarePolicy).
		Do(ctx).
		Into(result)
...
func (c *topologyAwarePolicies) UpdateStatus(ctx context.Context, topologyAwarePolicy *v1alpha1.TopologyAwarePolicy, opts v1.UpdateOptions) (result *v1alpha1.TopologyAwarePolicy, err error) {
	result = &v1alpha1.TopologyAwarePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("topologyawarepolicies").
...
func (c *topologyAwarePolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *topologyAwarePolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *topologyAwarePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TopologyAwarePolicy, err error) {
	result = &v1alpha1.TopologyAwarePolicy{}
