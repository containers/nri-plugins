...
func (in *BalloonDef) DeepCopyInto(out *BalloonDef) {
	*out = *in
	...
	if in.IrqClaim != nil {
		in, out := &in.IrqClaim, &out.IrqClaim
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LoadClass) DeepCopyInto(out *LoadClass) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadClass.
func (in *LoadClass) DeepCopy() *LoadClass {
	if in == nil {
		return nil
	}
	out := new(LoadClass)
