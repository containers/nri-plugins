...
require (
	...
	// Pinned to upstream intel/goresctrl main for pkg/monitor (intel/goresctrl#192).
	// Bump to a tagged release once one containing pkg/monitor is available.
	github.com/intel/goresctrl v0.13.1-0.20260909072821-5a73031e5834
