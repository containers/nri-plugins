...
expected_poliy=$SCHED_FIFO expected_prio=$((99 - 42)) verify-sched pod0c0

verify 'len(cpus["pod0c1"]) == 1'
expected_poliy=$SCHED_IDLE expected_prio=$((120 + 17)) verify-sched pod0c1
...
expected_poliy=$SCHED_FIFO expected_prio=$((99 - 10)) verify-sched pod1c0

verify 'len(cpus["pod1c1"]) != 1'
expected_poliy=$SCHED_IDLE expected_prio=$((120 + 17)) verify-sched pod1c1
...
expected_poliy=$SCHED_FIFO expected_prio=$((99 - 10)) verify-sched pod2c0

verify 'len(cpus["pod2c1"]) != 1'
expected_poliy=$SCHED_OTHER expected_prio=$((120 + 10)) verify-sched pod2c1
...
expected_poliy=$SCHED_OTHER expected_prio=$((120 + 10)) verify-sched pod3c0

verify 'len(cpus["pod3c1"]) != 1'
expected_poliy=$SCHED_IDLE expected_prio=$((120 + 17)) verify-sched pod3c1
...
expected_poliy=$SCHED_OTHER expected_prio=$((120 + 10)) verify-sched pod4c0

verify 'len(cpus["pod4c1"]) != 1'
expected_poliy=$SCHED_FIFO expected_prio=$((99 - 10)) verify-sched pod4c1
...
expected_poliy=$SCHED_FIFO expected_prio=$((99 - 10)) verify-sched pod5c0

verify 'len(cpus["pod5c1"]) != 1'
expected_poliy=$SCHED_OTHER expected_prio=$((120 + 10)) verify-sched pod5c1
...
expected_poliy=$SCHED_IDLE expected_prio=$((120 + 17)) verify-sched pod6c0

verify 'len(cpus["pod6c1"]) != 1'
expected_poliy=$SCHED_OTHER expected_prio=$((120 + 10)) verify-sched pod6c1
...
expected_poliy=$SCHED_OTHER expected_prio=$((120 + 10)) verify-sched pod7c0

verify 'len(cpus["pod7c1"]) != 1'
expected_poliy=$SCHED_OTHER expected_prio=$((120 + 0)) verify-sched pod7c1
...
expected_poliy=$SCHED_FIFO expected_prio=$((99 - 42)) verify-sched pod8c0

verify 'len(cpus["pod8c1"]) != 1'
expected_poliy=$SCHED_FIFO expected_prio=$((99 - 10)) verify-sched pod8c1
