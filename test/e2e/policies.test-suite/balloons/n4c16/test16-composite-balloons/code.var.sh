...
# new-on-node-1's component. Therefore first-min-balloons
# componentCreation of balance-both-nodes-on-either-pkg is expected to
# use component balance-pkg1-nodes instead of balance-pkg0-nodes: the
# latter would use "node0" and "node1" component balloons with already
