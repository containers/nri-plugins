...
POD_ANNOTATION="balloon.balloons.nri-resource-policy.intel.com: full-core" CONTCOUNT=2 create balloons-busybox
report allowed
verify-metrics-has-line 'balloon="default\[0\]"'
verify-metrics-has-line 'balloon="reserved\[0\]"'
...
POD_ANNOTATION="balloon.balloons.nri-resource-policy.intel.com: fast-dualcore" CONTCOUNT=1 create balloons-busybox
report allowed
...
POD_ANNOTATION="balloon.balloons.nri-resource-policy.intel.com: flex" CONTCOUNT=1 create balloons-busybox
report allowed
