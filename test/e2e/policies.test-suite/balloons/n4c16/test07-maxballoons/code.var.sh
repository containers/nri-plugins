...
POD_ANNOTATION="balloon.balloons.nri-resource-policy.intel.com: singleton" CONTCOUNT=1 create balloons-busybox
report allowed
...
( POD_ANNOTATION="balloon.balloons.nri-resource-policy.intel.com: singleton" CONTCOUNT=1 wait_t=5s create balloons-busybox ) && {
...
POD_ANNOTATION="balloon.balloons.nri-resource-policy.intel.com: dynamictwo" CONTCOUNT=1 create balloons-busybox
report allowed
...
CPUREQ="300m" CPULIM="300m"
( POD_ANNOTATION="balloon.balloons.nri-resource-policy.intel.com: dynamictwo" CONTCOUNT=1 wait_t=5s create balloons-busybox ) && {
